...
var TICK = ["Для банка и ипотеки","Автотранспорт","Для РУВД","Для налоговой","Для наследства","Раздел имущества","Оценка ущерба","Для суда","Квартиры и дома","Земельные участки","Коммерция","Заводы и оборудование","Узаконение","Перепланировка"];
var TICK_KZ = ["Банк пен ипотека үшін","Автокөлік","ІІБ үшін","Салық органы үшін","Мұрагерлік үшін","Мүлікті бөлу","Залалды бағалау","Сот үшін","Пәтерлер мен үйлер","Жер учаскелері","Коммерциялық нысандар","Зауыттар мен жабдық","Заңдастыру","Қайта жоспарлау"];
